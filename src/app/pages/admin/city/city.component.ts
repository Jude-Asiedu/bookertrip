...
export class CityComponent implements OnInit {
  ...
  apiKey:string = '21d6ab7fb651a5bc9ef7e834aee48592'
  citiesList:City[]= [];
  searchText:string = ''
  ...
  getAllCities(){
    this.http.get('https://api.aviationstack.com/v1/cities?access_key=21d6ab7fb651a5bc9ef7e834aee48592').subscribe(
      (res:any)=>{
  ...
  filteredCities(): City[] {
  return this.citiesList.filter((city:City) =>
